...
The mapping table is `PLATFORM` — which control an HTML element becomes is a property of the
platform. The specific colours, sizes and paddings in the examples are `EXAMPLE`: replace them
